...
def sell():
    ...
    # User reached route via POST
        ...
        # Ensure a user provided an integer without many zeros after decimal point and following digits
        # Such as 2.00000000000001 number or the like
        elif not float(shares_to_sell).is_integer():
            return apology("Provide an integer")
