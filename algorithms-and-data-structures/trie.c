// Here I implemented a "trie" structure for the problem set 4 of CS50
// To see the all related files and find more information go to (solved-cs50-psets -> 2018-fall -> pset4 -> speller)
