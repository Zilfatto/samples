...
// The merge sort is in the line 155. This file is from my pset3 of CS50
// I wanted to cut out and leave only a merge sort, but it is covered in context and without it might be misunderstood
// And moreover it is written in C, but I am currently using more high-level programming languagies
